**Overview:** Thi spreadsheet, 'Controls.xlsx' includes control sample data taken throughout the scanning campaign. Each observation is a unique NIR scan of a given control. 
