# Purpose: build baseline pls-2 model to predict XOS, Solids, and free xylose from Samples from all locations in the process stream using full spectral range
...
training <- rbind(
  readRDS("../data/processed/earlyWaste_training.RDS"),
  readRDS("../data/processed/late_training.RDS")
)

testing <- rbind(
  readRDS("../data/processed/earlyWaste_testing.RDS"),
  readRDS("../data/processed/late_testing.RDS")
)
...
write_rds(training, "../data/processed/part1_fullDataSet_training.RDS")
write_rds(testing, "../data/processed/part1_fullDataSet_testing.RDS")
