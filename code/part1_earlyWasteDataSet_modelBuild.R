# Purpose: build baseline pls-2 model to predict XOS, Solids, and free xylose from Samples from early/waste locations in the process stream using full spectral range
...
write_rds(training, "../data/processed/part1_earlyWasteDataSet_training.RDS")
write_rds(testing, "../data/processed/part1_earlyWasteDataSet_testing.RDS")
